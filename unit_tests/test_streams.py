...
def patch_base_class(mocker):
    ...
    mocker.patch.object(DatadogUsageStream, "path", "v0/example_endpoint")
    mocker.patch.object(DatadogUsageStream, "primary_key", "test_primary_key")
    mocker.patch.object(DatadogUsageStream, "__abstractmethods__", set())
